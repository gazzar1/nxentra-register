...
class ItemCreateSerializer(serializers.Serializer):
    ...
    default_unit_price = serializers.DecimalField(max_digits=18, decimal_places=2, required=False, default=Decimal("0"))
    default_cost = serializers.DecimalField(max_digits=18, decimal_places=2, required=False, default=Decimal("0"))
...
class TaxCodeSerializer(serializers.ModelSerializer):
    ...
    rate_percentage = serializers.DecimalField(
        max_digits=7, decimal_places=2, read_only=True, help_text="Tax rate as percentage (e.g., 15 for 15%)"
    )
