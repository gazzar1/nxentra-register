...
class SourceSystemUpdateSerializer(serializers.Serializer):
    ...
    system_type = serializers.ChoiceField(choices=SourceSystem.SystemType.choices, required=False)
    trust_level = serializers.ChoiceField(choices=SourceSystem.TrustLevel.choices, required=False)
...
class MappingProfileSerializer(serializers.ModelSerializer):
    ...
    source_system_code = serializers.CharField(source="source_system.code", read_only=True)
...
class MappingProfileCreateSerializer(serializers.Serializer):
    ...
    default_debit_account_code = serializers.CharField(max_length=20, required=False, allow_blank=True, default="")
    default_credit_account_code = serializers.CharField(max_length=20, required=False, allow_blank=True, default="")
...
class MappingProfileUpdateSerializer(serializers.Serializer):
    ...
    posting_policy = serializers.ChoiceField(choices=MappingProfile.PostingPolicy.choices, required=False)
    default_debit_account_code = serializers.CharField(max_length=20, required=False, allow_blank=True)
    default_credit_account_code = serializers.CharField(max_length=20, required=False, allow_blank=True)
...
class IdentityCrosswalkSerializer(serializers.ModelSerializer):
    ...
    source_system_code = serializers.CharField(source="source_system.code", read_only=True)
    source_system_name = serializers.CharField(source="source_system.name", read_only=True)
    verified_by_email = serializers.CharField(source="verified_by.email", read_only=True, default="")
...
class IdentityCrosswalkCreateSerializer(serializers.Serializer):
    ...
    external_label = serializers.CharField(max_length=500, required=False, allow_blank=True, default="")
    nxentra_id = serializers.CharField(max_length=255, required=False, allow_blank=True, default="")
    nxentra_label = serializers.CharField(max_length=500, required=False, allow_blank=True, default="")
...
class IdentityCrosswalkUpdateSerializer(serializers.Serializer):
    ...
    nxentra_id = serializers.CharField(max_length=255, required=False, allow_blank=True)
    nxentra_label = serializers.CharField(max_length=500, required=False, allow_blank=True)
    external_label = serializers.CharField(max_length=500, required=False, allow_blank=True)
...
class IngestionBatchSerializer(serializers.ModelSerializer):
    ...
    source_system_code = serializers.CharField(source="source_system.code", read_only=True)
    source_system_name = serializers.CharField(source="source_system.name", read_only=True)
    mapping_profile_name = serializers.CharField(source="mapping_profile.name", read_only=True, default="")
    staged_by_email = serializers.CharField(source="staged_by.email", read_only=True, default="")
    committed_by_email = serializers.CharField(source="committed_by.email", read_only=True, default="")
    rejected_by_email = serializers.CharField(source="rejected_by.email", read_only=True, default="")
