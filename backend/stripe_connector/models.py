...
class StripeCharge(models.Model):
    ...
    company = models.ForeignKey(Company, on_delete=models.CASCADE, related_name="stripe_charges")
    account = models.ForeignKey(StripeAccount, on_delete=models.CASCADE, related_name="charges")
    public_id = models.UUIDField(default=uuid.uuid4, unique=True, editable=False)
...
class StripeRefund(models.Model):
    ...
    company = models.ForeignKey(Company, on_delete=models.CASCADE, related_name="stripe_refunds")
    charge = models.ForeignKey(StripeCharge, on_delete=models.CASCADE, related_name="refunds")
    public_id = models.UUIDField(default=uuid.uuid4, unique=True, editable=False)
...
class StripePayout(models.Model):
    ...
    company = models.ForeignKey(Company, on_delete=models.CASCADE, related_name="stripe_payouts")
    account = models.ForeignKey(StripeAccount, on_delete=models.CASCADE, related_name="payouts")
    public_id = models.UUIDField(default=uuid.uuid4, unique=True, editable=False)
...
class StripePayoutTransaction(models.Model):
    ...
    company = models.ForeignKey(Company, on_delete=models.CASCADE, related_name="stripe_payout_transactions")
    payout = models.ForeignKey(StripePayout, on_delete=models.CASCADE, related_name="transactions")
    public_id = models.UUIDField(default=uuid.uuid4, unique=True, editable=False)
