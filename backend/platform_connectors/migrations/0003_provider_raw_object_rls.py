"""Enable Postgres row-level security on provider_raw_object.

ProviderRawObject holds raw, PII-bearing provider payloads per company, so it
joins the same RLS tenant-isolation regime as its peers (accounting_account /
...
reconciliation/migrations/0002_reconciliation_link_rls.py.
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("platform_connectors", "0002_providerrawobject_and_more"),
    ]
