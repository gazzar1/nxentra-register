...
export default function VendorBalancesPage() {
  ...
  const filteredBalances = data?.balances?.filter((b) => {
    ...
    return (
      b.vendor_code.toLowerCase().includes(searchLower) ||
      b.vendor_name.toLowerCase().includes(searchLower) ||
      ...
      <div className="space-y-6 print:space-y-0">
        <div className="no-print">
          <PageHeader
            ...
            subtitle="Accounts Payable subledger balances"
            actions={
          ...
          <CardContent className="pt-6 print:p-0">
            {isLoading ? (
              ...
              <EmptyState
                ...
                description="No vendor balance data available."
              />
            ) : (
              <>
                {/* Report Header */}
                <div className="text-center mb-6 print:mb-8">
                  ...
                  <h3 className="text-lg mt-2">Vendor Balances (AP Subledger)</h3>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead className="w-28">Last Bill</TableHead>
                    ...
                    <TableBody>
                      {filteredBalances.map((balance) => {
                        ...
                        return (
                          <TableRow key={balance.vendor_code}>
