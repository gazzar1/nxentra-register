...
### A128. CSV date-format sniffer can't disambiguate DD/MM vs MM/DD + import form uses locale-native date pickers — **~2-4h** (imports UX/correctness, surfaced 2026-06-12)
...
### A129. Settlement clearance JE: not idempotent per batch, orphaned by statement deletion, inconsistent currency — **~1-2d** (reconciliation correctness, surfaced 2026-06-12 during screencast prep)
