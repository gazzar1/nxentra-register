...
- **Unblocks:** C4a (header write removal, "trivial after PR-D") → C4b (line write removal + reconcile re-point + verify-view internals + exception re-key + admin/backups registry entries + date-range-totals decision + retire s2c).
